...
| --- | --- | ---: | ---: | --- |
| /dashboard | LCP | 381 мс | <= 2500 мс | выполнен |
...
| /details/line-a | LCP | 371 мс | <= 2500 мс | выполнен |
...
| /reports | LCP | 371 мс | <= 2500 мс | выполнен |
...
| /settings | LCP | 370 мс | <= 2500 мс | выполнен |
